...
object Data {
  ...
  def getOrders():  Orders = {
    ...
    val order1 = Order(1, 1, 1, OrderStatus.Ordered, "01012016", "0")
    val order2 = Order(2, 1, 2, OrderStatus.Ordered, "02012016", "0")
    val order3 = Order(3, 1, 2, OrderStatus.Ordered, "03012016", "0")
